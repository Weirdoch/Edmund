...
class LibraryFragment : Fragment() {
    ...
    private fun populateData() {
        ...
        readingBooks.add("Book 1.4 - Reading")
        readingBooks.add("Book 1.5 - Reading")
        readingBooks.add("Book 1.6- Reading")
        readingBooks.add("Book 1.7 - Reading")
        readingBooks.add("Book 1.8 - Reading")
        readingBooks.add("Book 1 - Reading")
        readingBooks.add("Book 1.1 - Reading")
        readingBooks.add("Book 1.2 - Reading")
        readingBooks.add("Book 1.3 - Reading")
        ...
        readingBooks.add("Book 1.7 - Reading")
        readingBooks.add("Book 1.8 - Reading")
        alreadyReadBooks.add("Book 2 - Already Read")
        planningBooks.add("Book 3 - Planning")
        droppedBooks.add("Book 4 - Dropped")
    }
